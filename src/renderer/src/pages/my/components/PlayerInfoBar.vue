      ...
      <div class="flex items-start gap-4">
        <div class="relative">
          ...
          >
            <div class="relative">
              ...
              <div
                class="absolute bottom-1 right-1/2 translate-x-1/2 px-1 rounded-sm w-max w-full text-center text-2.5 font-bold"
                :style="{
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="text-4.5 font-bold">
            大区：<span @click="handleCopy(summoner.region)">{{ summoner.region }}</span>
          </div>
          <div class="flex flex-col gap-2">
...
import { TAGS_ENUM } from "src/renderer/src/utils/common";
import { ref } from "vue";
...
// 在模板中使用 GAME_COUNTS 替代 gameCountOptions
</script>
